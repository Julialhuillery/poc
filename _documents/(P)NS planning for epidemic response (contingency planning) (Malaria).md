...
| **Infectious agent** | There are five _Plasmodium_ (parasite) species that cause malaria in humans, and two of these species – _P. falciparum_ and _P. vivax_ – pose the greatest threat. |
...
| **Incubation period** | Seven to forty days. Antimalarial drugs taken for prophylaxis by travellers can delay the appearance of malaria symptoms by weeks or months, long after the traveller has left the malaria-endemic area. |
...
| Use of insecticide-treated bed nets (coverage must be at least 80% to be effective) | ✔ | &nbsp; | &nbsp; | &nbsp; |
...
| Households who receive indoor residual spraying (specific time period) | # or % |
